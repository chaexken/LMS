Public Class BookDetail
    ...
    Sub readData()
        ListView1.Clear()
        ListView1.Columns.Add("CALL NUMBER", 90, HorizontalAlignment.Center)
        ListView1.Columns.Add("GROUP ID", 90, HorizontalAlignment.Center)
        ListView1.Columns.Add("BOOK TITLE", 310, HorizontalAlignment.Center)
        ...
        ListView1.Columns.Add("COPYRIGHT", 90, HorizontalAlignment.Center)
